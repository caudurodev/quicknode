...
export type GetTrendingCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetTrendingCollectionsQuery = { __typename?: 'RootQuery', trendingCollections?: { __typename?: 'ContractConnection', edges?: Array<{ __typename?: 'ContractEdge', node?: { __typename?: 'BaseContract', address: string } | { __typename?: 'ERC721Contract', name?: string | null, unsafeOpenseaImageUrl?: string | null, unsafeOpenseaExternalUrl?: string | null, address: string } | null } | null> | null } | null };


export const GetTrendingCollectionsDocument = gql`
...
/**
 * __useGetTrendingCollectionsQuery__
 *
 * To run a query within a React component, call `useGetTrendingCollectionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTrendingCollectionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTrendingCollectionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetTrendingCollectionsQuery(baseOptions?: Apollo.QueryHookOptions<GetTrendingCollectionsQuery, GetTrendingCollectionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTrendingCollectionsQuery, GetTrendingCollectionsQueryVariables>(GetTrendingCollectionsDocument, options);
      }
export function useGetTrendingCollectionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTrendingCollectionsQuery, GetTrendingCollectionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTrendingCollectionsQuery, GetTrendingCollectionsQueryVariables>(GetTrendingCollectionsDocument, options);
        }
export type GetTrendingCollectionsQueryHookResult = ReturnType<typeof useGetTrendingCollectionsQuery>;
export type GetTrendingCollectionsLazyQueryHookResult = ReturnType<typeof useGetTrendingCollectionsLazyQuery>;
export type GetTrendingCollectionsQueryResult = Apollo.QueryResult<GetTrendingCollectionsQuery, GetTrendingCollectionsQueryVariables>;